...
export const createEngineControlRoute = ({ engineControlService }: EngineControlRouteDependencies) => {
    ...
    route.post(
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof containerCreateRequestSchema> }>) =>
            context.json(await engineControlService.createContainer(context.req.valid('json')), 201),
        ),
    )
    route.get(
        '/images',
    ...
    route.get(
        ...
        withErrorHandling(async (context: AgentRouteContext<{ param: z.infer<typeof imageIdParamSchema> }>) =>
            context.json(await engineControlService.getImageRemovalImpact((context.req.valid('param') as { imageId: string }).imageId), 200),
        ),
    )
    route.get(
        '/networks',
    ...
    route.get(
        ...
        withErrorHandling(async (context: AgentRouteContext<{ query: z.infer<typeof prunePreviewQuerySchema> }>) =>
            context.json(await engineControlService.getPrunePreview(context.req.valid('query')), 200),
        ),
    )
    route.post(
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof buildCachePruneRequestSchema> }>) =>
            context.json(await engineControlService.pruneBuildCache(context.req.valid('json')), 200),
        ),
    )
    route.post(
        '/networks',
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof networkCreateRequestSchema> }>) =>
            context.json(await engineControlService.createNetwork(context.req.valid('json')), 201),
        ),
    )
    route.post(
        '/volumes',
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof volumeCreateRequestSchema> }>) =>
            context.json(await engineControlService.createVolume(context.req.valid('json')), 201),
        ),
    )
    route.post(
        '/images/pull',
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof imagePullRequestSchema> }>) =>
            context.json(await engineControlService.pullImage(context.req.valid('json')), 200),
        ),
    )
    route.post(
        '/images/:imageId/tag',
        ...
        withErrorHandling(
            async (context: AgentRouteContext<{ param: z.infer<typeof imageIdParamSchema>; json: z.infer<typeof imageTagRequestSchema> }>) =>
                context.json(
                    await engineControlService.tagImage((context.req.valid('param') as { imageId: string }).imageId, context.req.valid('json')),
                    200,
                ),
        ),
    )
    route.post(
        ...
        withErrorHandling(async (context: AgentRouteContext<{ json: z.infer<typeof imageLoadRequestSchema> }>) =>
            context.json(await engineControlService.loadImage(context.req.valid('json')), 200),
        ),
    )
    route.post(
        ...
        withErrorHandling(
            async (context: AgentRouteContext<{ param: z.infer<typeof containerIdParamSchema>; json: z.infer<typeof containerActionSchema> }>) =>
                context.json(
    ...
    route.post(
        ...
        withErrorHandling(
            async (context: AgentRouteContext<{ param: z.infer<typeof containerIdParamSchema>; json: z.infer<typeof containerExecRequestSchema> }>) =>
                context.json(
    ...
    route.post(
        ...
        withErrorHandling(
            async (
                context: AgentRouteContext<{ param: z.infer<typeof containerIdParamSchema>; json: z.infer<typeof containerNetworkAttachmentSchema> }>,
            ) =>
                context.json(
        ...
        withErrorHandling(
            async (
                context: AgentRouteContext<{
                    ...
                    json: z.infer<typeof containerHealthProbeRequestSchema>
                }>,
            ) =>
                context.json(
    ...
    route.delete(
        ...
        withErrorHandling(
            async (context: AgentRouteContext<{ param: z.infer<typeof imageIdParamSchema>; json: z.infer<typeof imageRemoveRequestSchema> }>) =>
                context.json(
                    await engineControlService.removeImage((context.req.valid('param') as { imageId: string }).imageId, context.req.valid('json')),
                    200,
                ),
        ),
    )
    route.delete(
        ...
        withErrorHandling(
            async (
                context: AgentRouteContext<{ param: z.infer<typeof networkIdParamSchema>; json: z.infer<typeof dockerResourceRemoveRequestSchema> }>,
            ) =>
                context.json(
                    await engineControlService.removeNetwork(
                        (context.req.valid('param') as { networkId: string }).networkId,
                        context.req.valid('json'),
                    ),
                    200,
                ),
    ...
    route.delete(
        ...
        withErrorHandling(
            async (
                context: AgentRouteContext<{ param: z.infer<typeof volumeNameParamSchema>; json: z.infer<typeof dockerResourceRemoveRequestSchema> }>,
            ) =>
                context.json(
                    await engineControlService.removeVolume(
                        (context.req.valid('param') as { volumeName: string }).volumeName,
                        context.req.valid('json'),
                    ),
                    200,
                ),
