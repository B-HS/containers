...
const DropdownMenuItem = ({
    ...
    <DropdownMenuPrimitive.Item
        ...
        className={cn(
            "relative flex cursor-default items-center gap-2 px-2 py-1.5 text-sm outline-hidden select-none focus:bg-overlay-hover focus:text-text-strong data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 data-[variant=destructive]:text-danger data-[variant=destructive]:focus:bg-danger-surface data-[variant=destructive]:focus:text-danger [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-text-muted data-[variant=destructive]:*:[svg]:text-danger!",
            className,
        )}
        {...props}
    />
...
const DropdownMenuCheckboxItem = ({ className, children, checked, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.CheckboxItem>) => (
    <DropdownMenuPrimitive.CheckboxItem
        ...
        className={cn(
            "relative flex cursor-default items-center gap-2 py-1.5 pr-2 pl-8 text-sm outline-hidden select-none focus:bg-overlay-hover focus:text-text-strong data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
            className,
        )}
...
const DropdownMenuLabel = ({
    ...
    <DropdownMenuPrimitive.Label
        ...
        data-inset={inset}
        className={cn('px-2 py-1.5 text-sm font-medium text-text-strong data-[inset]:pl-8', className)}
        {...props}
    />
)
...
const DropdownMenuShortcut = ({ className, ...props }: React.ComponentProps<'span'>) => (
    <span data-slot="dropdown-menu-shortcut" className={cn('ml-auto text-xs tracking-widest text-text-subtle', className)} {...props} />
)
...
const DropdownMenuSubTrigger = ({
    ...
    <DropdownMenuPrimitive.SubTrigger
        ...
        data-inset={inset}
        className={cn(
            "flex cursor-default items-center gap-2 px-2 py-1.5 text-sm outline-hidden select-none focus:bg-overlay-hover focus:text-text-strong data-[inset]:pl-8 data-[state=open]:bg-overlay-active data-[state=open]:text-text-strong [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-text-muted",
            className,
        )}
        {...props}
    >
