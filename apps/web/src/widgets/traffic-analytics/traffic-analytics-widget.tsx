...
import { TrafficExportControl } from '@features/traffic-export-control/traffic-export-control'
...
export const TrafficAnalyticsWidget: FC<TrafficAnalyticsWidgetProps> = ({ analytics, canExport, labels }) => (
    <section className="mt-px min-w-0 overflow-hidden bg-card" aria-labelledby="traffic-analytics-title">
        <header className="flex items-center justify-between p-3">
            <h2 id="traffic-analytics-title" className="text-sm font-semibold">
                {labels.title}
            </h2>
            <div className="flex items-center gap-2">
                {canExport ? (
                    <TrafficExportControl
                        labels={{
